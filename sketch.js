...
function preload() {
  bgImg = loadImage("Background302.jpg");
  playerImg = loadImage("302bird.png");
}
...
let platforms = [
  ...
  { x: 90,  y: 320, w: 130, h: 26 }, // left low platform
  { x: 290, y: 250, w: 150, h: 26 }, // centre platform
  { x: 510, y: 180, w: 130, h: 26 }, // right high platform
  { x: 180, y: 170, w: 110, h: 26 }, // left high platform
  { x: 370, y: 330, w: 120, h: 26 }, // centre low platform
  { x: 630, y: 300, w: 140, h: 26 }, // far right platform
  { x: 30, y: 230, w: 100, h: 26, bounce: true, color: [255, 100, 180] }, // new
];
